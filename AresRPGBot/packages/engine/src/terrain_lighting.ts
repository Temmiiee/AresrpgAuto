...
export const LIT_FACE_BRIGHTNESS = Object.freeze([1, 1, 1, 1, 1, 1] as const)
...
export const lit_face_brightness = (face: number): number => LIT_FACE_BRIGHTNESS[Math.max(0, Math.min(5, face))]!
