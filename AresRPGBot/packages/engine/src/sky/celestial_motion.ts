 ...
 */
export function celestial_angle_at(elapsed_ms: number, anchor_tod = 0, cycle_ms = CELESTIAL_CYCLE_MS): number {
 ...
 */
export function celestial_tod_at(elapsed_ms: number, anchor_tod = 0, cycle_ms = CELESTIAL_CYCLE_MS): number {
